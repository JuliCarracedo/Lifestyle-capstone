Rails.application.routes.draw do
  ...
  post "/votes/create/:user_id/:article_id/:category_id", to: "votes#create", as: :create_vote
  delete "/vote/:user_id/:article_id/:category_id", to: "votes#destroy", as: :destroy_vote
